...
const DashboardAnalytics = () => {
  ...
  return (
    <div className="bg-white rounded px-6 py-4 mb-6 h-full overflow-y-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-14 md:mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6 md:mb-14">
        <div className="h-64 md:h-80">
          <h3 className="text-lg font-semibold mb-2 text-[#001f61]">
            Quizzes by Category
          </h3>
      ...
      <div className="h-64 md:h-80">
        ...
        <div className="h-full">
          <Bar
            data={{
              labels: analyticsData.topPerformingQuizzes.map(
                (quiz) => quiz.name
              ),
              datasets: [
                {
                  label: "Average Score",
                  data: analyticsData.topPerformingQuizzes.map(
                    (quiz) => quiz.score
                  ),
